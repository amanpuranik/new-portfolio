  ...
  <VerticalTimeline className='timelineContainer'>
    ...
    >
      ...
      <p>
        ...
        Pixlee Turnto was my final internship in undergrad and its here that I met some of the most talented developers. But if theres one value that I would take away from Pixlee, it would be the willingness to help. <br></br>
    ...
    >
      ...
      <p>
        ...
        But this skill set is imperative anywhere in tech, with new tools constantly being released and the landscape constantly changing. So I'm thankful I "learned how to learn" early on in my career.
    ...
    >
      ...
      <p>
        DigitalEd is an ed-tech startup based in Waterloo, Ontario that specializes in making software that assists in the creation and deployment of STEM courses for universities and colleges.<br></br>
        DigitalEd also was my first job/internship in tech ever and acted as my entrance into the field. This being my first job was very intimidating if I'm being honest. I suddenly felt like there were so many concepts and principles that I had to learn to be able to code in an enterprise setting.<br></br>
        It was here I realized that writing code for fun little side projects was not the same as writing code for work. I was lucky to have an extremely gracious mentor however, and I was able to learn a lot from him in a very short amount of time.<br></br>
